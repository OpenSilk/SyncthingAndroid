...
public class SessionRecyclerAdapterTest {
    ...
    public void testNotificationAdd() {
        ...
        notifs.add(new NotifCardRestart(null));
        notifs.add(new NotifCardRestart(null));
    ...
    public void testNotificationReplaceMore() {
        ...
        notifs2.add(new NotifCardRestart(null));
        notifs2.add(new NotifCardRestart(null));
        notifs2.add(new NotifCardRestart(null));
        notifs2.add(new NotifCardRestart(null));
    ...
    public void testFolderAdd() {
        ...
        folders.add(new FolderCard(null, null, null));
        folders.add(new FolderCard(null, null, null));
        folders.add(new FolderCard(null, null, null));
    ...
    public void testFolderReplaceMore() {
        ...
        f1.id = "id1";
        folders.add(new FolderCard(null, f1, null));

        FolderConfig f2 = new FolderConfig();
        f2.id = "id2";
        folders.add(new FolderCard(null, f2, null));
        ...
        f3.id = "id1";
        folders2.add(new FolderCard(null, f3, null));

        FolderConfig f4 = new FolderConfig();
        f4.id = "id2";
        folders2.add(new FolderCard(null, f4, null));

        FolderConfig f5 = new FolderConfig();
        f5.id = "id3";
        folders2.add(new FolderCard(null, f5, null));

        FolderConfig f6 = new FolderConfig();
        f6.id = "id4";
        folders2.add(new FolderCard(null, f6, null));
    ...
    public void testSetDevices() {
        ...
        devices.add(new DeviceCard(null, null, null, null, 0));
        devices.add(new DeviceCard(null, null, null, null, 0));
        devices.add(new DeviceCard(null, null, null, null, 0));
    ...
    public void testSetDevicesMore() {
        ...
        d1.deviceID = "id1";
        devices.add(new DeviceCard(null, d1, null, null, 0));

        DeviceConfig d2 = new DeviceConfig();
        d2.deviceID = "id2";
        devices.add(new DeviceCard(null, d2, null, null, 0));

        DeviceConfig d3 = new DeviceConfig();
        d3.deviceID = "id3";
        devices.add(new DeviceCard(null, d3, null, null, 0));
        ...
        d4.deviceID = "id1";
        devices2.add(new DeviceCard(null, d4, null, null, 0));

        DeviceConfig d5 = new DeviceConfig();
        d5.deviceID = "id2";
        devices2.add(new DeviceCard(null, d5, null, null, 0));

        DeviceConfig d6 = new DeviceConfig();
        d6.deviceID = "id3";
        devices2.add(new DeviceCard(null, d6, null, null, 0));

        DeviceConfig d7 = new DeviceConfig();
        d7.deviceID = "id4";
        devices2.add(new DeviceCard(null, d7, null, null, 0));

        DeviceConfig d8 = new DeviceConfig();
        d8.deviceID = "id5";
        devices2.add(new DeviceCard(null, d8, null, null, 0));
    ...
    public void testgetItem() {
        List<NotifCard> notifs = new LinkedList<>();
        notifs.add(new NotifCardRestart(null));//0
        notifs.add(new NotifCardRestart(null));//1
        adapter.setNotifications(notifs, false);
        //2
        List<FolderCard> folders = new LinkedList<>();
        folders.add(new FolderCard(null, null, null));//3
        folders.add(new FolderCard(null, null, null));//4
        folders.add(new FolderCard(null, null, null));//5
        adapter.setFolders(folders, false);
        //6
        MyDeviceCard myDevice = new MyDeviceCard(null, null, null, null);
        adapter.setThisDevice(myDevice, true);//7
        List<DeviceCard> devices = new LinkedList<>();
        devices.add(new DeviceCard(null, null, null, null, 0));//8
        devices.add(new DeviceCard(null, null, null, null, 0));//9
        devices.add(new DeviceCard(null, null, null, null, 0));//10
        adapter.setDevices(devices, false);
